...
#to apply Eigenvalue Decay on the embedding and dense layers of the deep
#pipeline
...
model = Sequential()
model.add(Embedding(max_features, embedding_size, input_length=maxlen,W_regularizer=EigenvalueRegularizer(0.001))) #Applying Eigenvalue Decay with C=0.001
...
model.add(Dense(1,W_regularizer=EigenvalueRegularizer(0.0009))) #Applying Eigenvalue Decay with C=0.0009
