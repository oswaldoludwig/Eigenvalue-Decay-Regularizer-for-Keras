...
model.add(Dense(512,W_regularizer=EigenvalueRegularizer(0.0006))) #Applying Eigenvalue Decay with C=0.0006
model.add(Activation('relu'))
model.add(Dropout(0.2))
model.add(Dense(10,W_regularizer=EigenvalueRegularizer(0.004))) #Applying Eigenvalue Decay with C=0.004
