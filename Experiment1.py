...
on the Reuters newswire topic classification (RNTC) task.
'''
...
model = Sequential()
model.add(Dense(520, input_shape=(max_words,),W_regularizer=EigenvalueRegularizer(0.0001))) #Applying Eigenvalue Decay with C=0.0001
model.add(Activation('relu'))
model.add(Dropout(0.5))
model.add(Dense(nb_classes,W_regularizer=EigenvalueRegularizer(0.005))) #Applying Eigenvalue Decay with C=0.005
